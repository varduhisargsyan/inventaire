        ...
        <div class="col-md-10">
            <div class="row cloture ">
                <div class="col-md-1 col-md-offset-6">
                    <a href="request_.action">  <span class="cloture glyphicon glyphicon-remove-circle"></span></a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4  col-md-offset-2 panel panel-default">
                    <div class="panel-heading">
                        <span class="form_panel_heading_gl glyphicon glyphicon-bookmark"></span><span
                            class="form_panel_heading_txt"><s:text name="text.request_edit"/></span>
                    </div>
                    <s:form action="request_update">
                        <s:hidden name="bookRequest.id"/>
                        <s:hidden name="bookRequest.status"/>
                        <s:hidden name="bookRequest.description"/>
                        <s:hidden name="bookRequest.orderDate"/>
                        <s:textfield name="bookRequest.author" key="text.author"></s:textfield>
                        <s:textfield name="bookRequest.title" key="text.title"></s:textfield>

                        <s:select list="categoryList" name="bookRequest.category.id" listValue="name" listKey="id" headerKey="-1" headerValue="---------------" key="text.category"></s:select>


                        <s:select list="clientList" name="bookRequest.client.id" listKey="id"
                                  listValue="%{lname+' '+ fname}" key="text.client"/>
                        <s:textarea name="bookRequest.decsription" key="text.desc"/>
