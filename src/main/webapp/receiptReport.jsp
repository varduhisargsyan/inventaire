...
<div class="container-fluid">
    ...
    <div class="row content">
        ...
        <div class="col-md-10">
            <s:form action="receiptReport" cssClass="form-inline">
                <div class="row" style="padding: 10px">
                    <div class="col-md-4">
                        <sj:datepicker  size="28px" placeholder="%{getText('text.startDate')}" cssClass="form-control"  name="startDate" displayFormat="dd-mm-yy"/>

                    </div>
                    <div class="col-md-4">
                        <sj:datepicker size="28px" placeholder="%{getText('text.endDate')}" cssClass="form-control" maxlength="200px" name="endDate" displayFormat="dd-mm-yy" />
                    </div>
                </div>


                <div class="row">
                    <div class="col-md-1" style="padding-left:306px; padding-top: 30px;">
            ...
            <div class="row content_body">
                    ...
                    <display:table name="recievedBooks"  pagesize="30" export="true" requestURI="receiptReport" id="report" class="pagination">
                        <display:column title="#"><s:property value="#attr.report_rowNum"/> </display:column>
