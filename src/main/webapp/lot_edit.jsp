            ...
            <div class="row">
                <div class="col-md-4  col-md-offset-2 panel panel-default">
                    ...
                    <div class="panel-heading">
                        <span class="form_panel_heading_gl glyphicon glyphicon-bookmark"></span><span class="form_panel_heading_txt"><s:text name="text.update_client"/></span>
                    </div>
                    <s:form action="lot_update">
                        <s:hidden name="bookCase.id"></s:hidden>
                        <s:hidden  name="bookCase.insertionDate"/>
