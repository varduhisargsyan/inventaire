...
<div class="container-fluid">
    ...
    <div class="row content">
        <div class="col-md-2 menu_sidebar  list-group">
            <a class="home list-group-item" href="inventaire.action"><span
            ...
            <div class="row">
                <div class="col-md-4  col-md-offset-2 panel panel-default">
                    ...
                    <div class="panel-heading">
                        <span class="form_panel_heading_gl glyphicon glyphicon-bookmark"></span>
                        <span class="form_panel_heading_txt"><s:text name="text.add_book"/></span>

                    </div>


                    <s:form action="book_save">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <s:select name="book.category.id" list="categoryList" listValue="name" listKey="id"/>
