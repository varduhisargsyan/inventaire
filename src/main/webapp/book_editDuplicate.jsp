                ...
                <div class="col-md-4  col-md-offset-2 panel panel-default">
                    <div class="panel-heading">
                        <span class="form_panel_heading_gl glyphicon glyphicon-bookmark"></span><span
                            class="form_panel_heading_txt"><s:text name="text.update_book"/></span>
                    </div>
                    ...
                    <s:form action="book_update">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <s:textfield name="book.price" key="text.price" readonly="true"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <s:textfield name="book.category.name" readonly="true"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <s:submit cssClass="btn btn-primary pull-right" key="text.submit"/>
                            </div>
                        </div>
