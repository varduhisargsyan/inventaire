        ...
        <div class="col-md-10">
            ...
            <div class="row content_body">
                ...
                <s:if test="books!=null">
                    <display:table name="books" id="books" pagesize="20" requestURI="inventaire" export="true"
                                   class="pagination">
                        ...
                        <display:column media="html" class="controls">
                            ...
                            <s:url action="book_prepareDelete" id="prepare_delete_url">
                                <s:param name="bookId" value="#attr.books.id"></s:param>
                            </s:url>
                            ...
                            <s:a href="%{prepare_delete_url}" cssClass="control btn btn-link btn-md"><span
                                    class="glyphicon glyphicon-trash"></span></s:a>
                            <s:a href="%{show_url}" cssClass="control btn btn-link btn-md"><span
                                    class="glyphicon glyphicon-eye-open"></span></s:a>

                            <s:if test="#attr.books.totalquantity<1">
                                <s:a href="%{sale_url}" cssClass="control btn btn-link btn-md disabled"><span
                                        class="glyphicon glyphicon-shopping-cart"></span></s:a>
                            </s:if>
                            <s:else> <s:a href="%{sale_url}" cssClass="control btn btn-link btn-md"><span
