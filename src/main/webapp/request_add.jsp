...
<div class="container-fluid">
    <div class="row">
        <nav action="basicSearch" class="navbar navbar-default">
            <a class="navbar-brand"  href="#"><img src="/img/logo.jpg"  alt="logoSP"/></a>

            <div>
                <s:form cssClass="navbar-form navbar-right">
                ...
                <div class="col-md-4  col-md-offset-2 panel panel-default">
                    <div class="panel-heading">
                        <span class="form_panel_heading_gl glyphicon glyphicon-bookmark"></span><span
                            class="form_panel_heading_txt"><s:text name="text.request_add"/></span>
                    </div>
                    <s:form action="request_save">
                        <s:textfield name="bookRequest.author" key="text.author"/>
                        <s:textfield name="bookRequest.title" key="text.title"/>
                        <s:select list="categoryList" name="bookRequest.category.id" listKey="id" listValue="name" headerValue="-----------" headerKey="-1" key="text.category"></s:select>
                        <s:select list="clientList" name="bookRequest.client.id" listKey="id" listValue="%{lname+' '+fname}" key="text.client"/>
