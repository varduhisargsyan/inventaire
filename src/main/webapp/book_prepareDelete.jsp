...
<s:text name="text.prepare_delete"></s:text>
            </div>
            ...
            <div class="content_body">
                    ...
                    <table class="pagination">
                        ...
                        <tr>
                            ...
                            <td class="controls">
                                <s:url action="book_delete" id="execute_delete_url">
                                    <s:param name="bookId" value="book.id"></s:param>
                                </s:url>
                                <s:a href="%{execute_delete_url}" cssClass="btn btn-primary btn-xs "><span><s:text name="text.execute_delete"/></span></s:a>
                                <s:url action="inventaire" id="abandone_delete_url">
                                    <s:param name="categoryId" value="book.category.id"></s:param>
                                </s:url>
                                <s:a href="%{abandone_delete_url}" cssClass="btn btn-primary btn-xs "><span><s:text name="text.abandone_delete"/></span></s:a>
                            </td>
                        </tr>
