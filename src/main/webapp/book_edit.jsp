        ...
        <div class="col-md-10">
            ...
            <div class="col-md-4  col-md-offset-2 panel panel-default">
                <div class="panel-heading">
                    <span class="form_panel_heading_gl glyphicon glyphicon-bookmark"></span><span class="form_panel_heading_txt"><s:text name="text.update_book"/></span>
                </div>
                <s:form action="book_update">
                    <div class="row">
                        <div class="col-md-12">
                            <s:hidden name="book.id"/>
                            <s:textfield name="book.title" key="text.title"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <s:textfield name="book.author" key="text.author" cssStyle="text-transform: uppercase"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <s:textfield name="book.price" key="text.price_unit"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            <s:textfield name="book.quantityinstore" />
                        </div>
                        <div class="col-md-4">
                            <s:textfield name="book.quantityinstock"/>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-12">
                            <s:select list="categoryList" listKey="id" listValue="name" name="book.category.id"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <s:submit cssClass="btn btn-primary" key="text.submit"/>
                        </div>
                    </div>
