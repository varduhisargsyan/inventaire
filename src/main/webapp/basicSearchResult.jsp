    ...
    <div class="row content">
        ...
        <div class="col-md-10">
            ...
            <div class="row content_body">
                    ...
                    <s:else>
                        <display:table name="searchResults" id="searchResults" requestURI="basicSearch" pagesize="20"
                                       class="pagination">

                            <display:column title="#" class="wide"><s:property value="#attr.searchResults_rowNum"/>
                            </display:column>
                            ...
                            <display:column media="html" class="controls">
                                <s:url action="book_edit" id="edit_url">
                                    <s:param name="bookId" value="#attr.searchResults.id"></s:param>
                                </s:url>
